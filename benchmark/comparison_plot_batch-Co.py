...
if __name__ == "__main__":
    ...
    model_results = {
        "synbo (GP_EHVI)": {
            "results_path": "results/multiple_20260403_211317/all_batches_final_round_*.csv",
            "target_columns": ["yield", "ee"],
            "direction_tags": ["max", "max"],
        },
        "synbo (GP_UCB)": {
            "results_path": "results/multiple_20260403_211537/all_batches_final_round_*.csv",
            "target_columns": ["yield", "ee"],
            "direction_tags": ["max", "max"],
        },
    }

    full_space_file = "datasets/Oracle_datasets/Co-enamine/Co-enamine.csv"
