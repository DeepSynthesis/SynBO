...
data_dir = global_dir / Path("datasets/Oracle_datasets/")
...
CONFIG = {
    ...
    "batch_size": 5,
    "data_paths": {
        "dataset_file": str(data_dir / "Co-enamine/Co-enamine.csv"),
        "descriptor_dir": str(data_dir / "Co-enamine/descriptors"),
        "results_base_dir": str(global_dir / "results"),
    },
    "reaction_space": {
        "reagent_types": ["alkali", "amine", "cobalt", "oxidant", "solvent"],
        "name_suffix": "_desc",
    },
